...
void mrb_mruby_core_graphics_gem_init(mrb_state *mrb) {
  ...
  mrb_define_method(mrb, sdl_texture, "clear", sdl_texture_clear, MRB_ARGS_REQ(4));
  mrb_define_method(mrb, sdl_texture, "draw_child_texture", sdl_texture_draw_child_texture, MRB_ARGS_REQ(1));
